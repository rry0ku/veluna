...
settings-notice = Copyright © 2026 Veluna Contributors. Veluna kommt ohne jede Gewährleistung. Es ist freie Software, und du darfst es unter den Bedingungen der GNU General Public License Version 3 oder später weitergeben. Veluna ist inoffiziell und steht in keiner Verbindung zu Spotify AB.
...
update-detail-notes = Du hast { $running }. Sieh dir an, was sich geändert hat, und aktualisiere Veluna so, wie du es installiert hast.
...
settings-check-updates-detail = Beim Start einmal bei GitHub nachfragen, ob eine neuere Version da ist. Veluna installiert das Update nur unter Windows selbst, sonst zeigt es dir, was sich geändert hat
