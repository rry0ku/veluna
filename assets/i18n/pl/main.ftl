...
settings-notice = Copyright © 2026 Veluna Contributors. Veluna jest dostarczana bez żadnej gwarancji. To wolne oprogramowanie, które możesz rozpowszechniać na warunkach GNU General Public License w wersji 3 lub nowszej. Veluna jest nieoficjalnym klientem i nie jest powiązana ze Spotify AB.
...
settings-check-updates-detail = Zapytaj GitHuba przy starcie, czy jest nowsza wersja. Veluna instaluje aktualizację sama tylko w systemie Windows, w pozostałych pokazuje, co się zmieniło
