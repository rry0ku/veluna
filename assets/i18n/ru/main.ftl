...
settings-notice = Copyright © 2026 Veluna Contributors. Veluna поставляется без каких-либо гарантий. Это свободное программное обеспечение, и вы можете распространять его на условиях GNU General Public License версии 3 или новее. Veluna — неофициальный клиент и не связан со Spotify AB.
...
update-detail-notes = У вас { $running }. Посмотрите, что изменилось, и обновите Veluna так же, как устанавливали.
...
settings-check-updates-detail = Один раз при запуске спрашивать GitHub, вышла ли новая версия. Veluna устанавливает обновление сама только в Windows, в остальных системах показывает, что изменилось
