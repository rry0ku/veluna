...
settings-notice = Copyright © 2026 Veluna Contributors. Veluna постачається без жодних гарантій. Це вільне програмне забезпечення, і ви можете поширювати його на умовах GNU General Public License версії 3 або новішої. Veluna — неофіційний клієнт і не пов'язаний зі Spotify AB.
...
update-detail-notes = У вас { $running }. Подивіться, що змінилося, і оновіть Veluna так само, як встановлювали.
...
settings-check-updates-detail = Один раз під час запуску питати GitHub, чи вийшла новіша версія. Veluna встановлює оновлення сама лише у Windows, в інших системах показує, що змінилося
