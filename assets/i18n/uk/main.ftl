...
login-problem-network = Veluna не змогла зв'язатися зі Spotify. Перевірте інтернет-з'єднання та спробуйте ще раз.
...
login-problem-premium = Veluna відтворює музику через Spotify Premium, а цей акаунт його не має. Увійдіть в акаунт з Premium, щоб продовжити.
...
login-browser-detail = Veluna прочитає сесію YouTube Music з обраного браузера. Сесія залишиться на цьому пристрої.
...
login-usage-consent = Допоможіть нам оцінити, скільки людей користується Veluna.
...
login-account-detail = У цій сесії виконано вхід у кілька акаунтів Google. Виберіть той, який має використовувати Veluna.
...
settings-saver-detail = Обмежувати частоту кадрів анімації, коли Veluna не у фокусі, починаючи з наступного запуску
...
settings-startup-detail = Екран, який Veluna відкриває на старті
...
settings-language-detail = Мова інтерфейсу Veluna
...
settings-typeface-detail = Шрифт інтерфейсу Veluna
...
settings-version-detail = Складання Veluna, яке зараз запущено
settings-license = Ліцензія
settings-license-detail = Загальна публічна ліцензія GNU v3.0 (GPL-3.0)
...
settings-notice = Copyright © 2026 Veluna Contributors. Veluna постачається без жодних гарантій. Це вільне програмне забезпечення з відкритим кодом, і ви можете поширювати його на умовах Загальної публічної ліцензії GNU версії 3 (GPL-3.0). Veluna — неофіційний клієнт і не пов'язаний зі Spotify AB.
...
toast-download-complete = Трек { $name } завантажено
toast-download-failed = Не вдалося завантажити { $name }
...
update-available = Вийшла Veluna { $version }
update-detail = У вас { $running }. Подивіться, що змінилося, або оновіться зараз.
update-detail-notes = У вас { $running }. Завантажте останній реліз із GitHub для оновлення.
...
settings-check-updates-detail = Під час запуску перевіряти GitHub на наявність нової версії
settings-check-now = Перевірка оновлень вручну
settings-check-now-detail = Перевірити наявність останньої версії Veluna на GitHub
settings-check-now-btn = Перевірити зараз
settings-checking-updates = Перевірка…
toast-update-available = Доступне оновлення: { $name }
toast-update-up-to-date = У вас остання версія
toast-update-failed = Не вдалося перевірити оновлення
